...
| [superpowers/reports/2026-09-12-operator-client-profile-verification.md](superpowers/reports/2026-09-12-operator-client-profile-verification.md) | Automatické a databázové ověření P1.6; autentizovaný browser průchod aktivního assignmentu zůstává doložitelně blokovaný datovou dostupností. |
...
| [superpowers/reports/2026-09-14-p1-8-runtime-dependency-audit.md](superpowers/reports/2026-09-14-p1-8-runtime-dependency-audit.md) | P1.8 audit runtime závislostí telefonie, bezpečné patch aktualizace a důkaz hranice telefonního adaptéru. |
