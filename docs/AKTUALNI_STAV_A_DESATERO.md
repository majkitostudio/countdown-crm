...
- [ ] dokončit další zúžení navigace podle denní práce role — podrobnosti v sekci P2 níže,
...
- [x] role-aware úvodní plocha: `/` serverově ověří workspace roli a pošle operátora do Operator Console, Team Leadera do Exception Queue a administrátora do Workspace Readiness; původní Dashboard Overview zůstává na `/dashboard` jen pro Team Leadera a administrátora,
