...
export default async function WalletPage() {
  ...
  return (
    <div className="mx-auto max-w-screen-2xl space-y-8">
      ...
      {data.canManage && data.settings && <WalletManagerPanel mode="adjustment" settings={data.settings} rules={data.rules} members={data.members} />}
