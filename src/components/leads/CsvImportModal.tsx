            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between p-3 bg-zinc-950 border border-zinc-800 rounded-xl">
                ...
                <button
                  ...
                  className="text-xs text-rose-400 hover:text-rose-300 font-medium px-2 py-1 bg-rose-500/10 rounded border border-rose-500/20"
                >
                  Change File
                </button>
              </div>
                  ...
                  <div className="space-y-2">
                    {previewItems.map((item, idx) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-2.5 py-1 rounded-md font-semibold">
        ...
        <div className="px-6 py-4 border-t border-zinc-800 bg-zinc-950 flex items-center justify-between">
          ...
          {file && (
            <button
              ...
              className="px-5 py-2 bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-zinc-950 font-semibold rounded-lg text-xs flex items-center gap-2 transition-all shadow-md"
            >
              {isImporting ? (
                <span>Importing...</span>
              ) : (
