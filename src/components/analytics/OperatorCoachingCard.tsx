  ...
  return (
    <div className="bg-zinc-900/40 border border-zinc-800/80 backdrop-blur-md rounded-2xl p-6 shadow-sm space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-zinc-800/80 pb-4">
        ...
        <span className="px-3 py-1 bg-emerald-950/80 text-emerald-400 border border-emerald-800/60 rounded-xl text-xs font-semibold flex items-center gap-1.5">
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-bold text-xs text-zinc-100">{ag.name}</h3>
                  <p className="text-[10px] text-zinc-500">{ag.role}</p>
                </div>
                <span className="px-2 py-0.5 bg-amber-500/10 text-amber-300 border border-amber-500/20 rounded font-mono font-bold text-[10px]">
              ...
              <div className="grid grid-cols-3 gap-2 pt-2 border-t border-zinc-800/60 text-[10px] text-zinc-400">
                <div>
                  <span className="block text-zinc-600 font-mono">Hovory</span>
                  <span className="font-semibold text-zinc-200 font-mono">{ag.callsCount}</span>
                </div>
                <div>
                  <span className="block text-zinc-600 font-mono">Námitky</span>
                  <span className="font-semibold text-emerald-400 font-mono">{ag.objectionSuccess}%</span>
                </div>
                <div>
                  <span className="block text-zinc-600 font-mono">Compliance</span>
                  <span className="font-semibold text-cyan-400 font-mono">{ag.complianceRating}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 bg-zinc-900/60 border border-zinc-800/80 rounded-lg space-y-1 text-[11px] mt-2">
              <div className="flex items-center gap-1 font-semibold text-amber-400 text-[10px]">
