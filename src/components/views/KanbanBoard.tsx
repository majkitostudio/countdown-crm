                    ...
                    >
                      ...
                      {activeBlueprint.customAttributes.length > 0 && (
                        <div className="flex flex-wrap gap-1 pt-1">
                          <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-medium bg-zinc-900 border border-zinc-800 text-zinc-400">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-zinc-800/60">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-zinc-900 hover:bg-emerald-950 text-zinc-400 hover:text-emerald-400 border border-zinc-800 transition-colors cursor-pointer"
                          title="Vytočit hovor"
                        >
