...
import { TrendingUp, Activity, Smile, Frown, AlertCircle, Sparkles } from "lucide-react";
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-1 h-3 rounded-lg overflow-hidden bg-zinc-900 p-0.5 border border-zinc-800">
          {segments.map((seg, idx) => (
            ...
            >
              {/* Tooltip on hover */}
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 bg-zinc-900 border border-zinc-700 text-[10px] text-zinc-200 rounded opacity-0 group-hover:opacity-100 pointer-events-none whitespace-nowrap z-30 transition-opacity">
